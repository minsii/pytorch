...
// If set, ProcessGroupNCCL registers postAlloc and preFree hooks to cuda cache allocator
// so that whenever a tensor is allocated or freed, ProcessGroupNCCL can register/deregister
// the tensor on all available NCCL communicators.
